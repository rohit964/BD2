...
function hotelAssendedByPricing (hotel1, hotel2){
  return hotel1.price - hotel2.price;
}
function hotelDecendedByPricing (hotel1, hotel2){
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === "low-to-high"){
    hotelsCopy.sort(hotelAssendedByPricing);
  }else{
...
function hotelAssendedByRating (hotel1, hotel2){
  return hotel1.rating - hotel2.rating;
}
function hotelDecendedByRating (hotel1, hotel2){
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === "low-to-high"){
    hotelsCopy.sort(hotelAssendedByRating);
  }else{
...
function hotelAssendedByReviews (hotel1, hotel2){
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === "least-to-most"){
    hotelsCopy.sort(hotelAssendedByReviews);
  }else{
    hotelsCopy.sort(hotelDecendedByRating);
  }
  res.json(hotelsCopy);
